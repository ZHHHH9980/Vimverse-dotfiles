...
_G.packer_plugins = {
  ...
  fzf = {
    loaded = true,
    path = "/Users/bytedance/.local/share/nvim/site/pack/packer/start/fzf",
    url = "https://github.com/junegunn/fzf"
  },
  ["fzf.vim"] = {
    loaded = true,
    path = "/Users/bytedance/.local/share/nvim/site/pack/packer/start/fzf.vim",
  ...
  nerdcommenter = {
    loaded = true,
    path = "/Users/bytedance/.local/share/nvim/site/pack/packer/start/nerdcommenter",
  ...
  rnvimr = {
    loaded = true,
    path = "/Users/bytedance/.local/share/nvim/site/pack/packer/start/rnvimr",
  ...
  ["vim-sandwich"] = {
    loaded = true,
    path = "/Users/bytedance/.local/share/nvim/site/pack/packer/start/vim-sandwich",
